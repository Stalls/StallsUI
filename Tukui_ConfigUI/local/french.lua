if GetLocale() == "frFR" then
	...
	TukuiL.option_general_multisample = "Protection Multisample (bord 1px clean)"
	...
	TukuiL.option_nameplates_enable = "Activer Barres d'info"
	...
	TukuiL.option_datatext_guild = "Position Guilde"
	TukuiL.option_datatext_arp = "Position Pénétration d'Armure"
	TukuiL.option_datatext_mem = "Position Mémoire"
	TukuiL.option_datatext_bags = "Position Sacs"
	TukuiL.option_datatext_fontsize = "Taille du texte"
	TukuiL.option_datatext_fps_ms = "Position Latence et FPS"
	TukuiL.option_datatext_armor = "Position Armure"
	TukuiL.option_datatext_avd = "Position Evitement"
	TukuiL.option_datatext_power = "Position Puissance Attaque / Sorts"
	TukuiL.option_datatext_haste = "Position Hâte"
	TukuiL.option_datatext_friend = "Position Amis"
	TukuiL.option_datatext_time = "Position Heure"
	TukuiL.option_datatext_gold = "Position Pièces d'Or"
	TukuiL.option_datatext_dps = "Position Dégâts par seconde"
	TukuiL.option_datatext_crit = "Position Critique"
	TukuiL.option_datatext_dur = "Position Durabilité"
	...
	TukuiL.option_unitframes_runebar = "Activer la barre de rune pour DK"
	...
	TukuiL.option_unitframes_wstimer = "Afficher le timer d'Ame affaiblie (prêtre seulement)"
	...
	TukuiL.option_unitframes_wstarget = "Afficher la barre d'Ame Affaiblie sur cible (prêtre seulement)"
	TukuiL.option_unitframes_enemypower = "Afficher le pouvoir (mana/énergie/rage) seulement sur l'ennemi"
	TukuiL.option_unitframes_gridonly = "N'afficher que le mode Grid sur l'interface Healer"
	TukuiL.option_unitframes_healcomm = "Activer healcomm"
	TukuiL.option_unitframes_focusdebuff = "Afficher les debuffs du Focus"
	TukuiL.option_unitframes_wsplayer = "Activer la barre d'Ame Affaiblie sur soi"
	...
	TukuiL.option_unitframes_enemyhostilitycolor = "Colorer la barre de vie des ennemy en fonction de l'hostilité"
	...
	TukuiL.option_unitframes_range = "Transparence sur unité de Groupe/Raid hors portée"
	TukuiL.option_unitframes_maintank = "Afficher Main Tank"
	TukuiL.option_unitframes_mainassist = "Afficher Main Heal"
	TukuiL.option_unitframes_unicolor = "Afficher le theme avec une seule couleur (barre de vie grise)"
	TukuiL.option_unitframes_totdebuffs = "Afficher debuffs de la cible de la cible (interface Haute Resolution)"
	...
	TukuiL.option_tooltip_hidecombat = "Cacher tooltip bas-droit en combat"
	TukuiL.option_tooltip_hidebutton = "Cacher tooltip sur les barres d'actions"
	TukuiL.option_tooltip_hideuf = "Cacher tooltip sur les Unit Frames"
	TukuiL.option_tooltip_cursor = "Afficher tooltip sous le curseur"
	...
	-- reminder
	TukuiL.option_reminder = "Alerte de buff"
	TukuiL.option_reminder_enable = "Activer l'alerte de buff du joueur"
	TukuiL.option_reminder_sound = "Activer une alerte sonore pour l'alerte de buff"
	...
	TukuiL.option_cooldown_th = "Colorer en rouge le cooldown à X seconde"

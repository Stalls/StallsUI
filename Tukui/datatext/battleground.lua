...
if TukuiCF["datatext"].battleground == true then
	...
	Text1:SetFont(TukuiCF.media.pixelfont, TukuiCF["datatext"].fontsize)
	...
	Text2:SetFont(TukuiCF.media.pixelfont, TukuiCF["datatext"].fontsize)
	...
	Text3:SetFont(TukuiCF.media.pixelfont, TukuiCF["datatext"].fontsize)
